...
// We then create the map object with options. Adding the tile layers to the map ready for selection
var map = L.map("map", {
  center: [
    40.7, -94.5
  ],
  zoom: 3,
  layers: [streetsmap, satellitemap, dark]
});

// Adding our 'streetsmap' tile layer to the map.
...
// AJAX call retrieves our earthquake geoJSON data.
